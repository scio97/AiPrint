...
public class AdapterTest extends RecyclerView.Adapter<AdapterTest.PostViewHolder>{

    String [] description, shopImageBase64, shopUrl, userId, userImage;
    int [] price, like;

    public AdapterTest(PostTest postTest){
    ...
    public class PostViewHolder extends RecyclerView.ViewHolder{
        ...
        public PostViewHolder (@NonNull View itemView){
            ...
            imageViewShopImageBase64 = itemView.findViewById(R.id.imageViewShopImageBase64);
