...
public class WelcomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button registerButton = (Button) view.findViewById(R.id.BTN_registrati);
        registerButton.setOnClickListener(v-> {
            Navigation.findNavController(view).navigate(R.id.action_welcomeFragment_to_registerUserFragment);
        });

        Button loginButton = (Button) view.findViewById(R.id.BTN_accedi);
        loginButton.setOnClickListener(v-> {
            Navigation.findNavController(view).navigate(R.id.action_welcomeFragment_to_loginUserFragment);
        });
    }
